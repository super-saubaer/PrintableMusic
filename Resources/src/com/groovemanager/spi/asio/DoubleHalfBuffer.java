...
class DoubleHalfBuffer {
	...
	/**
	 * This buffer큦 current limit 
	 */
	private int limit,
	/**
	 * This buffer큦 current position
	 */
	position;
	/**
	 * This buffer큦 capacity
	 */
	private final int capacity;
	/**
	 * The first buffer큦 limit
	 */
	...
	/**
	 * Get his buffer큦 total capacity
	 * @return This buffer큦 total capcity in bytes
	 */
	public int capacity(){
		return capacity;
	}
	...
	/**
	 * Get this buffer큦 current limit
	 * @return This buffer큦 current limit
	 */
	public int limit(){
		return limit;
	}
	/**
	 * Set this buffer큦 limit
	...
	/**
	 * Get his buffer큦 current position
	 * @return This buffer큦 current position
	 */
	public int position(){
		return position;
	}
	/**
	 * Set this buffer큦 position
	...
	/**
	 * Get the number of bytes remaining between this buffer큦 current position
	 * and its limit
	...
	/**
	 * Set this buffer큦 position to zero
	 * @return This buffer
	 */
